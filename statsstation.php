        ...
        <div id="content">
            ...
            <div>
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#" >Statistics by Offences</a></li>
                    <li class="nav-item"><a class="nav-link" href="#" >Search using Civilian License No</a></li>
            ...
            <input type ="submit" value="Submit" class = "btn1" />
                ...
                <table class="table">
                    ...
                    <div class="Display">
                        ...
                        $sql = "SELECT station.PSID,psname,officialusername,copname,designation,phoneno,address,emailid FROM policerecord,station where station.psid = policerecord.psid and copname = '$name' or officialusername = '$name'" ;
						...
						echo "No users with name $name found!";
						}
						mysqli_close($conn);
					?>
                    </div>
